...
<footer class="navbar-default navbar-fixed-bottom">
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="background: rgb(57, 171, 111);;padding-top: 17px;padding-bottom: 10px;">
      ...
      <div class="container-fluid">
        ...
        <div style="padding-left: 14%; display: inline-block">
