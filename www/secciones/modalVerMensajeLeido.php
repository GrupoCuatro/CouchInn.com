<!-- Ventana ver un mensaje leido de contacto -->
    <div id="modalVerMensajeLeido<?php echo $row['id_contacto']; ?>" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
            <form id="role-form"  method="post" action="../layout/index.php?seccion=mensajes-contacto-leidos">
                ...
                <div class="modal-footer">    
                    <button type="submit" class="btn btn-info btn-md" title="Eliminar mensaje" style="width: 144px;">Eliminar mensaje</button>
 ...
 <!-- END Ventana ver un mensaje leido de contacto -->