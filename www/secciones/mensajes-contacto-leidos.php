<?php
	if(isset($_POST['id_contacto'])) {   // si llego el id del mensaje leido, actualizamos el mensaje.
		...
		$strQuery = "DELETE FROM `contacto-administrador` WHERE `id_contacto` = '".$id."'";
		$query = mysqli_query($conexion,$strQuery);
		
				
		if( mysqli_affected_rows($conexion) > 0){    //muestra un exito si el mensaje fue eliminado ?>
			<div class="col-lg-4 col-md-6 col-xs-10 col-md-offset-3 col-lg-offset-4 col-xs-offset-1 ">
            	<div class="alert alert-success text-center">
                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                    <strong>El mensaje fue eliminado correctamente.</strong>
            	</div>
        	</div> 
<?php		}else{   ?>
				<div class="col-lg-4 col-md-6 col-xs-10 col-md-offset-3 col-lg-offset-4 col-xs-offset-1 ">
            	<div class="alert alert-danger text-center">
                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                    <strong>El mensaje no pudo ser eliminado.</strong>
            	</div>
        	</div> 
<?php 	}		
	}
...
<?php if(isset($_SESSION['sistema_usuario'])  &&  $_SESSION['sistema_usuario']['rol_usuario'] == "Administrador" ) { //SI ESTA LOGUEADO Y ES ADMINISTRADOR PUEDE VER LOS MENSAJES LEIDOS ?>

<section>
<div class="col-lg-6 col-md-8 col-xs-10 col-md-offset-2 col-lg-offset-3 col-xs-offset-1 " style="margin-bottom: 210px;">	
<?php
	$strQuery = "SELECT * FROM `contacto-administrador` WHERE `leido_contacto` = true";
                  ...
                  <div class="panel-footer" style="padding-bottom: 0px;">
                   <center>
                   	   <div class="form-group">	
                            <label><button type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#modalVerMensajeLeido<?php echo $row['id_contacto']; ?>" style="width:100px" >Ver mensaje</button></label>                            
  ...
  <?php
  	// MODAL VER MENSAJE
  		require('../secciones/modalVerMensajeLeido.php');   
...
<?	   } // END WHILE 
		...
		<div class="col-lg-12 col-md-6 col-xs-10 col-md-offset-3 col-xs-offset-1 " style="padding-top: 40px;padding-bottom: 30px;margin-top: 25%;font-size: 18px;margin-left: 0px;">
            <div class="alert alert-info text-center">
                <strong>No existen mensajes leidos.</strong>
            </div>
        </div> 
